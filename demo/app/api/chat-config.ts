...
export const chatConfig: ChatRouteConfig = {
  ...
  fallbackProvider: (process.env.CHAT_FALLBACK_PROVIDER as ChatRouteConfig["fallbackProvider"]) || undefined,
  fallbackModel: process.env.CHAT_FALLBACK_MODEL || undefined,
